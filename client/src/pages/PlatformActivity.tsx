  ...
  return (
    <div className="p-6 max-w-full">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Activity & Login Events</h1>
          <p className="text-gray-500 text-sm mt-1">Monitor login activity and security events</p>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredEvents.map((evt: any) => (
                <tr key={evt.id} className={`hover:bg-gray-50 ${evt.suspiciousFlag ? "bg-yellow-50" : ""}`}>
