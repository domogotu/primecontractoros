    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-blue-100">Get help with PrimeContractorOS</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white/10 backdrop-blur border border-white/20 rounded-lg p-6">
            ...
            <p className="text-blue-100 mb-4">Email us at support@primecontractoros.com</p>
          ...
          <div className="bg-white/10 backdrop-blur border border-white/20 rounded-lg p-6">
            ...
            <p className="text-blue-100 mb-4">Call us at 1-800-PRIME-OS</p>
        ...
        <div className="bg-white/10 backdrop-blur border border-white/20 rounded-lg p-8 mb-12">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-blue-100">Go to Get Started and follow the 4-step setup process.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-blue-100">Go to Subscription and select your desired plan.</p>
            </div>
          </div>
        </div>
