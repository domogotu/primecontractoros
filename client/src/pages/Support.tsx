          ...
          <div className="p-8 rounded-lg bg-white border border-gray-200">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-500">Use the login page and click Forgot Password to receive a reset link via email.</p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">How do I invite team members?</h4>
                <p className="text-sm text-gray-500">Navigate to your workspace Users page and click Invite User. Enter their email and assign a role.</p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">How do I upgrade my plan?</h4>
                <p className="text-sm text-gray-500">Go to your Subscription page in the workspace settings to view and change your current plan.</p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">Can I export my data?</h4>
                <p className="text-sm text-gray-500">Yes. Use the Reports section to export data in CSV format. Contact support for bulk exports.</p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">What happens to my data if I cancel?</h4>
                <p className="text-sm text-gray-500">Your data is retained for 90 days after cancellation. You can reactivate anytime during that period.</p>
              </div>
            </div>
          </div>
