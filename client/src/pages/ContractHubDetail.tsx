...
export default function ContractHubDetail() {
  ...
  const hubSections = [
    ...
    { title: "Files", description: "Contract documents and file management", path: `/app/files?contractId=${cid}`, icon: FolderOpen, color: "bg-slate-50 text-slate-700 border-slate-200" },
