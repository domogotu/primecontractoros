          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 mt-1">
                All features are unlocked. Subscribe to a plan to enable billing and enforce usage limits.
              </p>
            </div>
          </div>
        </Card>
        ...
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              ...
              <Button
                className="w-full"
                variant={isCurrentPlan ? "outline" : plan.name === "Growth" ? "default" : "outline"}
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              Stripe is in test mode. Use card number <code className="bg-blue-100 px-1 rounded">4242 4242 4242 4242</code> with any future expiry date and CVC to test payments.
            </p>
          </div>
        </div>
      </Card>
